...
INSERT INTO public.users (id, username, email, password, user_role, company, birth_day, first_name, second_name, third_name, city, country, street, house_number, flat_number) VALUES (28, 'user1', 'user1@', '$2a$10$7UG3DYWF7T/1XCd.xAxRv.lhECiZdLxKxGv1Xnm45U4d8b2cDacda', 'ROLE_COMP_OWNER', 1, '1983-05-12', '', 'surname', '', 'Minsk', 'Belarus', 'Kolasa', '29', '1');
INSERT INTO public.users (id, username, email, password, user_role, company, birth_day, first_name, second_name, third_name, city, country, street, house_number, flat_number) VALUES (31, 'user4', 'user4@', '$2a$10$ZVUK0t/h9Fqsq0DtZYnNZuFr31YCQMEzaeqD9nspW6NhazKOHVvH2', 'ROLE_MANAGER', 1, '1985-09-01', 'managerName', 'surname', '', '', 'Беларусь', '', '', '');
