...
INSERT INTO public.cancellation_act (id, date, amount, price, consignment_id) VALUES (2, '2018-12-02', 3, 45, 2);
...
INSERT INTO public.product (id, name, status, description, product_consignment, cancellation_act, price, count, cancelled_count) VALUES (4, 'Чай', 1, 'Черный', 2, 2, 11, 144, 0);
INSERT INTO public.product (id, name, status, description, product_consignment, cancellation_act, price, count, cancelled_count) VALUES (3, 'Кофе', 5, '500г', 2, 2, 15, 197, 3);
...
INSERT INTO public.waybill (id, status, driver, auto, date_departure, date_arrival, check_date, user_id) VALUES (3, 2, 2, 2, '2018-12-07', '2018-12-05', '2018-12-02', 5);
...
SELECT pg_catalog.setval('public.company_locker_id_seq', 1, false);
